...
import landr.parser.CommandRegistryEntry;
...
public class Main {
  ...
  private static CommandRegistry createCommandRegistry(
      CommandEnvironment environment, boolean interactive) {
  ...
  private static void addOptionalEntry(
      CommandRegistryFactory factory, CommandEnvironment environment, String name) {
  ...
  private static void printBanner() {
    String banner =
        """
          ...
          \\__ \\/ _ \\ | '_|  | |__/ _` | ' \\ / _` || '_|
          |___/\\___/_|_|    |____\\__,_|_||_|\\__,_||_|
         """;
