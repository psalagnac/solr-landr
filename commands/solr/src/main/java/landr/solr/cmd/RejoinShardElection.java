...
/**
 * Command to invoke {@link CoreAdminParams.CoreAdminAction#REJOINLEADERELECTION} on a replica. This
 * requires the Solr client to be a cloud aware client.
 */
public class RejoinShardElection extends SolrCommand {
  ...
  public void execute(CommandExecutionContext context, SolrClient client)
    ...
    GenericSolrRequest request =
        new GenericSolrRequest(SolrRequest.METHOD.GET, CommonParams.CORES_HANDLER_PATH, params);
