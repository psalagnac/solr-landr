...
public abstract class SolrAdminCommand extends SolrCommand {
  ...
  protected void processAdminRequest(
      CommandExecutionContext context, CollectionAdminRequest.AsyncCollectionAdminRequest request)
      throws SolrServerException, IOException, CommandExecutionException {
  ...
  /**
   * Utility method to send an asynchronous command to the Solr cluster. The async ID is generated
   * and printed. Using this method instead of directly calling SolrJ is preferred.
   */
  ...
  public abstract static class AdminCommandBuilder {
