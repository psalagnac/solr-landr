...
/** Add a property to a single replica. This invokes ADDREPLICAPROP Solr API. */
public class AddReplicaProperty extends SolrAdminCommand {
  ...
  public void execute(CommandExecutionContext context, SolrClient client)
    ...
    CollectionAdminRequest.AddReplicaProp request =
        CollectionAdminRequest.addReplicaProperty(collection, shard, replica, name, value);
