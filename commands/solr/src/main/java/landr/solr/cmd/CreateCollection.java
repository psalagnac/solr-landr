...
public class CreateCollection extends SolrAdminCommand {
  ...
  public void execute(CommandExecutionContext context, SolrClient client)
    ...
    Create request =
        CollectionAdminRequest.createCollection(
            collection, config, shards, nrtReplicas, tlogReplicas, null);
  ...
  public static class Builder extends AdminCommandBuilder {
    ...
    /**
     * Set number of shards for the collection being created. If the parameter is zero or negative,
     * we use {@link #DEFAULT_SHARDS} instead.
     */
    ...
    /**
     * Set number of replicas for the collection being created. If the parameter is zero or
     * negative, we use {@link #DEFAULT_REPLICAS} instead.
     */
