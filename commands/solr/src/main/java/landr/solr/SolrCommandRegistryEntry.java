...
/**
 * Entry for all the base Solr commands. This entry is always loaded when initializing the console.
 */
public class SolrCommandRegistryEntry extends JacksonCommandRegistryEntry {
  ...
  public void register(CommandRegistry registry) {
    ...
    registerCommand(
        registry, new NoArgumentDescriptor<>("list-collections", ListCollections.class));
    registerCommand(
  ...
  private static SolrClient createSolrClient(String zkHost, String zkRoot) {
    ...
    return new CloudSolrClient.Builder(
            Collections.singletonList(zkHost), Optional.ofNullable(zkRoot))
        .build();
  }
}
