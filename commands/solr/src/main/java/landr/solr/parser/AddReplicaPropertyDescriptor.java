...
public class AddReplicaPropertyDescriptor extends AdminCommandDescriptor<AddReplicaProperty> {
  ...
  @Override
  public AddReplicaProperty buildCommand(CommandString string, ParserContext context)
      throws CommandParseException {

    AddReplicaProperty.Builder builder =
        parseCommonParams(string, context, AddReplicaProperty.Builder::new);
