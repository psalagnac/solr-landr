...
/**
 * Custom completer to resolve names from the Solr {@link ClusterState}, like collection names,
 * shard names, replica names...
 */
public class ClusterStateCompleter implements Completer {
  ...
  public enum CompletionType {
    ...
    /**
     * Completion based on names of shards from the selected collection. Completion is enabled only
     * if a valid collection name is already specified.
     */
    SHARD,
  ...
  @Override
  public List<Completion> completeArgument(
      CommandEnvironment env, String argument, String value, Map<String, String> others) {
  ...
  /**
   * Complete an argument value based on shard names. We must resolve the collection name first to
   * get list of shards.
   */
  private List<Completion> completeShard(
      ClusterState clusterState, String value, Map<String, String> others) {
  ...
  /**
   * Complete an argument value based on replica names. We must resolve the collection name first to
   * get list of replicas.
   */
  private List<Completion> completeReplica(
      ClusterState clusterState, String value, Map<String, String> others) {
   ...
   *
   * <p>We assume completion is enabled on collection names for another parameter than the currently
  ...
  /**
   * Probe the shard name to resolve replica names. There is no guarantee the returned shard name is
   * valid.
   */
