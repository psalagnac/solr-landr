...
public class CreateCollectionDescriptor extends AdminCommandDescriptor<CreateCollection> {
  ...
  @Override
  public CreateCollection buildCommand(CommandString string, ParserContext context)
    ...
    CreateCollection.Type type =
        getArgumentEnumValue(TYPE_PARAM, string, context, CreateCollection.Type.class);
