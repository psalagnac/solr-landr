...
/**
 * Abstract descriptor for collection level admin commands. All commands support collection name and
 * async parameters.
 */
public abstract class AdminCommandDescriptor<T extends SolrAdminCommand>
    extends SolrCommandDescriptor<T> {
  ...
  protected <B extends AdminCommandBuilder> B parseCommonParams(
      CommandString string, ParserContext context, Function<String, B> factory)
  ...
  protected void parseCommonParams(
      CommandString string, ParserContext context, AdminCommandBuilder builder)
      throws CommandParseException {
