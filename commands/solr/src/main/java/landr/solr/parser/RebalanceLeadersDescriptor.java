...
public class RebalanceLeadersDescriptor extends AdminCommandDescriptor<RebalanceLeaders> {
  ...
  static {
    SYNTAX = new CommandSyntax(NAME, COLLECTION_ARGUMENT, ASYNC_ARGUMENT);
  }
  ...
  @Override
  public RebalanceLeaders buildCommand(CommandString string, ParserContext context)
      throws CommandParseException {

    RebalanceLeaders.Builder builder =
        parseCommonParams(string, context, RebalanceLeaders.Builder::new);
