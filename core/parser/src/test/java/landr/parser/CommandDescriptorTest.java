...
public class CommandDescriptorTest {
  ...
  public void testEnumParameter() throws CommandParseException {
    ...
    assertEquals(
        MyNumber.ONE, descriptor.getArgumentEnumValue("arg1", string, context, MyNumber.class));
    assertEquals(
        MyNumber.TWO, descriptor.getArgumentEnumValue("arg2", string, context, MyNumber.class));

    // Enums are not case-sensitive
    assertEquals(
        MyNumber.THREE, descriptor.getArgumentEnumValue("arg3", string, context, MyNumber.class));
