...
public class StatementSplitterTest extends TokenizerTestBase {
  ...
  public void testSingleStatement() {
    ...
    // Just two words !
    assertTokens("foo bar", List.of("foo", "bar"), List.of(0, 4), List.of(2, 6));
  ...
  public void testEmptyStatements() {
    ...
    // Just separators
    assertTokens("; ;;", List.of(";", ";", ";"), List.of(0, 2, 3), List.of(0, 2, 3));
  ...
  public void testStatementIndexes() {
    ...
    assertTokensInStatement(
        "echo foo bar qux", List.of("echo", "foo", "bar", "qux"), List.of(0, 1, 2, 3));
  ...
  private void assertTokensInStatement(
      String command, List<String> expected, List<Integer> indexes) {
    StatementSplitter splitter = createTokenizer(command);
