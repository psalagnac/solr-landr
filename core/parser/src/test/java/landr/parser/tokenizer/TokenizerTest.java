...
public class TokenizerTest extends TokenizerTestBase {
  ...
  public void testTokenize() {
    ...
    assertTokens("\"foo bar\"", List.of("\"foo", "bar\""), List.of(0, 5), List.of(3, 8));
  }
  ...
  public void testIndexes() {
    ...
    // Simple tokens
    assertTokenIndexes("foo bar qux", List.of("foo", "bar", "qux"), List.of(0, 1, 2));

    // Phrase
    assertTokenIndexes("\"foo bar\"", List.of("\"foo", "bar\""), List.of(0, 1));
  }
