...
public class DebugPragmaTest {
  ...
  private static class AssertDebugCommandDescriptor extends CommandDescriptor<AssertDebugCommand> {
    ...
    protected AssertDebugCommandDescriptor(Flag flag) {
      super(new CommandSyntax(getDebugCommandName(flag), "value", new Argument("value", true)));
      this.flag = flag;
    }

    @Override
    public AssertDebugCommand buildCommand(CommandString string, ParserContext context)
