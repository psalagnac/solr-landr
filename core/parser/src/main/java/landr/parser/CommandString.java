...
public class CommandString {
  ...
  /**
   * Return an argument value, or {@code null} is unspecified in the command line. Context is
   * ignored.
   */
  ...
  /**
   * Parse the command line at the cursor position. If the input contains multiple statements, other
   * ones are ignored.
   */
