 ...
 *
 * <p>Mostly, we push some {@link CommandRegistryEntry} in the classpath, so there is no compile
 * time dependency (low cost dependency injection).
 */
public class CommandRegistryFactory {
  ...
  /**
   * Create new descriptor instances for all the known commands and add them into a new registry.
   */
   ...
   *
   * <p>This is mostly for testing purposes.
   */
   ...
   *
   * <p>It is used for internal commands.
   */
