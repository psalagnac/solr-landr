...
public class CommandStringLayout {
  ...
  /**
   * Returns the position of the statement in the command line. This is always {@code 0} if there is
   * a single statement.
   *
   * <p>This is not equivalent to the position of the parsed command since this also includes empty
   * statements.
   */
  public int getIndex() {
    return index;
  ...
  /**
   * Return the position in the input command string of the command name. This is always {@code 0}
   * if there is a single statement in input string.
   */
