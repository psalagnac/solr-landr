...
public class ParserContext {
  ...
  /**
   * When enabled, the parser adds an ewho command to print the name all the arguments of the
   * following command. This may be used only when executing a script.
   */
