...
public class CommandRegistry {
  ...
  /**
   * Register command with no help. Generic help with syntax usage is generated from the descriptor.
   */
  ...
  /**
   * Convenience method to get a command attribute. Return null if no command with this name is
   * known.
   */
  ...
  /**
   * Returns an immutable view on all command names. Iteration order is identical to the command
   * registration order.
   */
