...
public interface Help {
   ...
   *
   * <p>All the commands with the same section are grouped together in the global help.
   */
  String getSection();
  ...
  /**
   * Return full help text, when the user asks for help scoped on the command. If {@code null} is
   * returned, we use the summary instead.
   */
  String getDetails();
