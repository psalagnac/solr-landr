...
public class TerminalFactory {
  ...
  /**
   * Set a custom prompt to the terminal, or {@code null} to disable it. It is used only is the
   * terminal is created in interactive mode.
   */
  ...
  /**
   * Create a new terminal for interactive command execution. It supports both printing command
   * outputs and reading user inputs.
   */
  public ConsoleTerminal createInteractiveTerminal(
      CommandEnvironment environment, CommandRegistry registry) throws IOException {
