...
public abstract class CommandExecutionContext {
  ...
  /**
   * Print a message for verbose logging. Note this message is always printed, even if verbose is
   * not enabled. The call should check {@link #getVerbose()} first.
   */
  ...
  /**
   * Print a message with specified style for verbose logging. Note this message is always printed,
   * even if verbose is not enabled. The call should check {@link #getVerbose()} first.
   */
