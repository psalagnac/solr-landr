...
/**
 * Simple structure to override style when command writes into the context output. Depending on the
 * actual output implementation, supporting styles is optional.
 */
public class OutputStyle {
  ...
  /**
   * Check whether this style is the default style. Default style does not override any parameter in
   * the output format.
   */
