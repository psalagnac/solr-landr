 ...
 *
 * <p>It is used for example to store Solr client or Zookeeper client.
 */
public class CommandEnvironment {
  ...
  /**
   * Return a global property from the environment. Global properties are available when registering
